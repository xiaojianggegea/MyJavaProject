    ...
    public List<NewBeeMallIndexCategoryVO> getCategoriesForIndex() {
        ...
        if (!CollectionUtils.isEmpty(firstLevelCategories)) {
            ...
            for (GoodsCategory first : firstLevelCategories) {
                ...
                vo.setCategoryLevel(first.getCategoryLevel());
                vo.setCategoryName(first.getCategoryName());
                List<GoodsCategory> seconds = secondLevelCategories.stream().filter(i -> i.getParentId().equals(first.getCategoryId())).collect(Collectors.toList());
                vo.setSecondLevelCategoryVOS(seconds);
                newBeeMallIndexCategoryVOS.add(vo);
            }
