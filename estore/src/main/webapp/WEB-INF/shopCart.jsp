...
<body>
    ...
    <!--头部-->
    <div class="header3">
    	<a href="user/indexServlet"><img src="images/logo.png"  class="oneImg"></a>
	...
	<div class="mainCenter">
		...
		<div class="mainPro">
			...
			<c:forEach items="${ShopCar.orderLines }" var="orderLine" varStatus="status">
				<form action="user/changeShopCarBookNumServlet" method="post">
	                <table>
	                    <tbody>
	                        <tr>
	                            <td class="index">${status.index + 1 }</td>
	                            <td>
	                                <img src="${orderLine.book.image }" style="widows: 60px;height: 60px">
	                                 <span>
	                                    ${orderLine.book.name }
	                                    <br>
	                                </span>
	                            ...
	                            <td>
	                                ...
	                                <button>
	                                <a href="user/deleteOrderLineOfShopCarServlet?bookId=${orderLine.book.id }">取消</a>
	                                </button>
 ...
 -->
             <!-- <div class="bb">
                ...
                <div class="allButtom">
                    ...
                    <a href="user/confirmOrderServlet" class="caozuo">去提交</a>
