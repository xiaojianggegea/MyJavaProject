...
<body>
    ...
    <div class="content">
		...
		<form action="user/orderServlet" name="orderForm" method="post">
    		...
    		<div class="centerTop">
    			...
    			<ul class="adres">
						<c:forEach items="${shopAddressList }" var="address">
				    		<li>
				    			<input type="radio" name="addressId" value="${address.id }" style="width:50px">
				    			${address.receiveName }&nbsp;&nbsp;&nbsp;${address.address }&nbsp;&nbsp;&nbsp;${address.phone }
				    		</li>
						</c:forEach>
		    	</ul>
    				...
    				<c:forEach items="${ShopCar.orderLines }" var="orderLine" varStatus="status">
	    				<ul class="oneUL">
	    					<li>
	    						...
	    						<p>${orderLine.book.author }&nbsp;&nbsp;${orderLine.book.description }&nbsp;&nbsp;${orderLine.book.name }&nbsp;&nbsp;</p>
